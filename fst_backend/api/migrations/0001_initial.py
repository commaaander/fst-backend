# Generated by Django 4.2.6 on 2023-10-09 19:53
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('from_node', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='from_node_set', to='api.node')),
                ('to_node', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='to_node_set', to='api.node')),
            ],
            options={
        ...
        migrations.AddField(
            model_name='node',
            name='spouses',
            field=models.ManyToManyField(blank=True, to='api.node'),
        ),
        migrations.CreateModel(
            name='Member',
            fields=[
